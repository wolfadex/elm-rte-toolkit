...
var $author$project$RichText$Commands$selectBackward = function (state) {
	...
	if (_v0.$ === 1) {
		...
		if (!A2($author$project$RichText$Node$selectionIsBeginningOfTextBlock, selection, root)) {
...
var $author$project$RichText$Commands$selectForward = function (state) {
	...
	if (_v0.$ === 1) {
		...
		var selection = _v0.a;
		var root = $author$project$RichText$Model$State$root(state);
		if (!A2($author$project$RichText$Node$selectionIsEndOfTextBlock, selection, root)) {
