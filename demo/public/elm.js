// elm-watch hot {"version":"2.0.0-beta.3","targetName":"Demo","webSocketConnection":61359}
"use strict";
(() => {
...
${variant}`;
  ...
  var WEBSOCKET_CONNECTION = "61359";
...
var $author$project$Demo$OnUrlChangeRequested = function (a) {
	return {$: 'OnUrlChangeRequested', a: a};
};
var $author$project$Demo$OnUrlChanged = function (a) {
...
var $author$project$Demo$view = function (model) {
	return {
		body: _List_fromArray(
			[
				$elm$html$Html$text('RTE Toolkit')
			]),
		title: 'elm-rte-toolkit Demo'
	};
};
var $author$project$Demo$main = $elm$browser$Browser$application(
	{init: $author$project$Demo$init, onUrlChange: $author$project$Demo$OnUrlChanged, onUrlRequest: $author$project$Demo$OnUrlChangeRequested, subscriptions: $author$project$Demo$subscriptions, update: $author$project$Demo$update, view: $author$project$Demo$view});
