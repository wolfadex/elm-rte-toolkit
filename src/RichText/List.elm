...
type alias ListDefinitionContents =
    { ordered : RichText.Model.Element.Element
    , unordered : RichText.Model.Element.Element
    , item : RichText.Model.Element.Element
    }
...
using `RichText.Model.Command.combine`:
    ...
    listCommandMap : RichText.Config.Command.CommandMap
...
defaultCommandMap definition =
    ...
    RichText.Config.Command.emptyCommandMap
        |> RichText.Config.Command.set
            [ RichText.Config.Command.inputEvent "insertParagraph"
            , RichText.Config.Command.key [ RichText.Config.Keys.enter ]
            , RichText.Config.Command.key [ RichText.Config.Keys.return ]
            ]
        ...
        |> RichText.Config.Command.set
            [ RichText.Config.Command.inputEvent "deleteContentBackward"
            , RichText.Config.Command.key [ RichText.Config.Keys.backspace ]
            ]
            [ ( "joinListBackward", RichText.Config.Command.transform <| backspaceCommand ) ]
        |> RichText.Config.Command.set
            [ RichText.Config.Command.inputEvent "deleteContentForward"
            , RichText.Config.Command.key [ RichText.Config.Keys.delete ]
            ]
            [ ( "joinListForward", RichText.Config.Command.transform <| deleteCommand ) ]
        |> RichText.Config.Command.set
            [ RichText.Config.Command.inputEvent "deleteWordBackward"
            , RichText.Config.Command.key [ RichText.Config.Keys.alt, RichText.Config.Keys.backspace ]
            ]
            [ ( "joinListBackward", RichText.Config.Command.transform <| backspaceCommand ) ]
        |> RichText.Config.Command.set
            [ RichText.Config.Command.inputEvent "deleteWordForward"
            , RichText.Config.Command.key [ RichText.Config.Keys.alt, RichText.Config.Keys.delete ]
            ]
            [ ( "joinListForward", RichText.Config.Command.transform <| deleteCommand ) ]
    ...
    after =
        state
            (block
                ...
                (blockChildren <|
                    Array.fromList
                        [ block (RichText.Model.Element.element RichText.Definitions.orderedList [])
                            (blockChildren <|
                                Array.fromList <|
                                    [ block
    ...
    after =
        state
            (block
                ...
                (blockChildren <|
                    Array.fromList
                        [ block (RichText.Model.Element.element orderedList [])
                            (blockChildren <|
                                Array.fromList <|
                                    [ block
                                        (RichText.Model.Element.element listItem [])
                                        (blockChildren <|
                                            Array.fromList
                                                [ block
                                                    (RichText.Model.Element.element paragraph [])
