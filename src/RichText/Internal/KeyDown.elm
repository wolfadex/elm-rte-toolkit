module RichText.Internal.KeyDown exposing (handleKeyDown, handleKeyDownEvent, keyDownDecoder, preventDefaultOn, preventDefaultOnKeyDownDecoder, shouldPreventDefault)
